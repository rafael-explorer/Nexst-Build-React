      ...
      <div className="home-passos">
        <div className="home-two">
          ...
          <span className="home-text13">
            Salve os temas e plugins mais utilizados em pacotes pré formatados e
        ...
        <div className="home-three">
          ...
          <span className="home-text15">
            ...
            desenvolvimento escalável da Nexst Build. Aqui nós te entregamos
            sempre 3 instalações configuradas para: desenvolvimento (Docker com
            até 1.000 portas disponíveis e inúmeras imagens WP pré formatadas),
            homologação (com o sistema &quot;Dolly&quot;, que copia os dados de
            produção em segundos e mantém tudo sincronizado) e produção (o
      ...
      <div className="home-stats">
        <div className="home-stat">
          ...
          <span className="home-text24">
            Nosso trabalho é recompensado quando um de nossos clientes entra em
        ...
        <div className="home-stat1">
          ...
          <span className="home-text27">
            Foram centenas de Sites, Plugins, Temas e integrações desenvolvidos
            ao longo de 10 anos de atuação.
          </span>
        </div>
